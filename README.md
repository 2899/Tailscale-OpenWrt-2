...
```
wget -O- https://ghproxy.net/https://raw.githubusercontent.com/2899/Tailscale-OpenWrt/main/install.sh | sh
```

### 0x01 卸载
请注意不要在远程连接时卸载，会丢失ssh连接。 Use at your own risk
```
wget -O- https://ghproxy.net/https://raw.githubusercontent.com/2899/Tailscale-OpenWrt/main/uninstall.sh | sh
```
